...
const MOCK_DATA = {
  ...
  users: [
    ...
    },
    {
      ...
      course: 0,
      interests: [ 'Кошечки', 'Приюты', 'Тестирование' ],
      online: true,
      role: 'teacher',
    ...
    },
    {
      ...
      direction: 'Информационные системы и программирование',
      course: 0,
      interests: ["Андроид", "iOS", "Программирование"],
      online: true,
      role: 'teacher',
      bio: 'Преподаватель ОАТК',
    },
    {
      id: 8,
      ...
      direction: 'Автомобили и автомобильное хозяйство',
      course: 2,
      interests: ["Автомобили", "Покрышки", "Асфальт"],
      online: true,
      role: 'student',
      bio: 'Главный по асфальту и покрышкам',
    },
    {
      id: 9,
      ...
      direction: 'Информационные системы и программирование',
      course: 2,
      interests: ["iOS", "Android", "Программирование"],
      online: true,
      role: 'student',
      bio: 'Учусь на 2 курсе',
    },
