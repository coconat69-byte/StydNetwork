...
const MOCK_DATA = {
  ...
  users: [
    ...
    },
    {
      ...
      direction: 'Информационные системы и программирование',
      course: 3,
      interests: ['Код', 'ВАЗ', 'Сиды'],
      online: true,
      role: 'student',
      bio: 'ИСиП, третий курс. Люблю быстрый прототип в коде и классические жигули — в гараже ВАЗ 2107.',
    },
    {
      id: 3,
    ...
    },
    {
      ...
      course: 1,
      interests: ['Граффити', '1С', 'Эдиты'],
      online: true,
      role: 'student',
      bio: 'Первый курс. Делаю эдиты и графику, вдохновляюсь трастми и к1ран, параллельно смотрю в сторону 1С.',
    },
    {
      id: 5,
